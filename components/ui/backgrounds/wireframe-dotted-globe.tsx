...
export default function RotatingEarth({
    ...
    height = 600,
    className = "",
    globeColor = "rgba(10, 18, 40, 0.85)",
    dotColor = "#7096C8",
    strokeColor = "rgba(112, 150, 200, 0.5)",
    graticuleColor = "rgba(112, 150, 200, 0.15)",
}: RotatingEarthProps) {
    ...
    }, [width, height, globeColor, dotColor, strokeColor, graticuleColor])

    if (error) {
        return (
            <div className={`flex items-center justify-center rounded-2xl p-8 ${className}`}>
                <div className="text-center">
                    <p style={{ color: "#ef4444", fontWeight: 600, marginBottom: "0.5rem" }}>Error loading Earth visualization</p>
                    <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.85rem" }}>{error}</p>
                </div>
            </div>
        )
    }
